...
public class MouseControls : MonoBehaviour
{
    ...
    private void UsePower()
    {
        ...
        if (attack == AttackValue.Bite)
        {
            ...
            {
                SoundManager.Instance().PlaySingle("Bite");
        ...
        else if (attack == AttackValue.Cough)
        {
            ...
            {
                SoundManager.Instance().PlaySingle("Cough");
        ...
        else if (attack == AttackValue.Slap)
        {
            ...
            {
                SoundManager.Instance().PlaySingle("Slap");
        ...
        else if (attack == AttackValue.Sneeze)
        {
            ...
            {
                SoundManager.Instance().PlaySingle("Sneeze");
